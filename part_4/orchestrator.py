...
if args.demo:
    run("python train.py --data ../part_2/tiny.txt --out runs/part4-demo --bpe --vocab_size 8000 --epochs 1 --steps 300 --batch_size 16 --block_size 128 --n_layer 2" \
    " --n_head 2 --n_embd 128 --mixed_precision --grad_accum_steps 2 --log tensorboard")
