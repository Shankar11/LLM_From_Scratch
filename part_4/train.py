...
def main():
    ...
    p.add_argument('--out', type, default='runs/part4')
    ...
    p.add_argument('--warmpup_steps', type=int, default = 20)
    ...
    # output dir amd (possible) checkpoint
    ...
    if have_ckpt:
        ...
        print(f"[resume] laoded tokenizer from {tok_dir} (vocab={vocab_size})")
    else:
        if args.bpe:
            ...
            tok = None
            vocab_size = 256 # byte-level fallback (not recommended for Part4)
