...
def top_k_top_p_filtering(logits: torch.Tensor, top_k: int | None , top_p: float | None = None):
    """
    Fitlers a distribution of logits using top-k and/or nucleus  (top-p)  filtering.
    - logits: (B, vocab)
