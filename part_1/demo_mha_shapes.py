"""
Walkthrough of multi-head attention with explicit matrix maths and shapes
...
if __name__ == "__main__":
    ...
    #B - batch size, T - token sequence lenght(context length), d_model - embedding dimension, n_head - no of heads
    ...
    log("\nLegend")
    log(" B=batch, T=sequence lenght, d_model= embedding size, heads=n_head, d_head=d_model/heads ")
