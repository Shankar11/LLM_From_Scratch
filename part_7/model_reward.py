...
class RewardModel(nn.Module):
    ...
    """
    def __int__(self, vocab_size: int, block_size: int, n__layer: int = 4, n_head: int = 4, n_embd: int =256, dropout: float = 0.1):
        super().__init__()
        ...
        self.encoder = nn.TransformerEncoder(enc_layer,num_layers=n__layer)
