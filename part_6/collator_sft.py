...
class SFTCollator:
    ...
    def __init__(self, block_size: int=256, bpe_dir:str | None = None):
        ...
        if self.tok is None:
            raise RuntimeError("No tokenizer available. Install tokenizerts or ensure Part 3 ByteTokenizer exists.")
